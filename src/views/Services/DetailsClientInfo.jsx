...
export const ServiceDetailClientInfo = () => {
  return (
    <Card title="Información del Cliente">
      <div className="flex flex-col gap-y-3">
        <div className="flex flex-row justify-between items-center">
          <div className="flex flex-col">
            <h1 className="text-lg text-gray-800">Hotel Dann AC</h1>
            <h1 className="text-sm text-gray-500">CR 97 # 48 F - 101</h1>
          </div>
            ...
            >
              <ul className="flex flex-col divide-y divide-gray-200 dark:divide-gray-700">
                <li className="flex justify-between items-center gap-x-2 py-3 px-1">
                  ...
                  <p className="text-sm font-medium text-gray-500 dark:text-white">Cali</p>
                </li>
                <li className="flex justify-between items-center gap-x-2 py-3 px-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Telefono</p>
                  <p className="text-sm font-medium text-gray-500 dark:text-white">56546898</p>
                </li>
                <li className="flex justify-between items-center gap-x-2 py-3 px-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Barrio</p>
                  <p className="text-sm font-medium text-gray-500 dark:text-white">La Floresta</p>
                </li>
              </ul>
            </Accordion>
          </AccordionGroup>
