...
export const ServiceDetailCustomerInfo = ({ customer }) => {
  const { commercial_name, address, city, phone, document_id } = customer;
  return (
    <Card title="Información del Cliente">
      <div className="flex flex-col gap-y-3">
        <div className="flex flex-row justify-between items-center">
          <div className="flex flex-col">
            <h1 className="text-lg text-gray-800">{commercial_name}</h1>
            ...
            >
              <ul className="flex flex-col divide-y divide-gray-200 dark:divide-gray-700">
                <li className="flex justify-between items-center gap-x-2 py-3 px-1">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">NIT</p>
                  <p className="text-sm font-medium text-gray-500 dark:text-white">{document_id}</p>
                </li>
                <li className="flex justify-between items-center gap-x-2 py-3 px-1">
